	...
	public SelectStartView(Controller controller)
	{
		...
		j2.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				...
				SelectStartView.this.controller.getProcess().setCurrentWordNumber(rp.getCurrentWordNumber() + 1);
			}
		});
		...
		text1.addMouseListener(new MouseClickListener(){
			...
			public void mouseReleased(MouseEvent e) {
				...
				String[] matchedWords = SelectStartView.this.controller.matchInputString(str);
		...
		text2.addMouseListener(new MouseClickListener(){
		...
		text2.addKeyListener(new keyListener(){
			...
			public void keyReleased(KeyEvent e) {
				...
				if (keyChar >= KeyEvent.VK_0 && keyChar <= KeyEvent.VK_9 || e.getKeyChar() == KeyEvent.VK_BACK_SPACE || e.getKeyChar() == KeyEvent.VK_DELETE 
					...
					int max = SelectStartView.this.controller.checkInputNumber(input);
