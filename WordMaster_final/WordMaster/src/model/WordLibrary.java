...
public class WordLibrary {
	...
	public WordLibrary(ArrayList<SingleWord> wordlist, int NextWordNumber,
			String LibraryName) {
		this.wordlist = wordlist;
		this.NextWordNumber = NextWordNumber;
	...
	public SingleWord getLastWordNumber() {
		return wordlist.get(NextWordNumber);
	}
