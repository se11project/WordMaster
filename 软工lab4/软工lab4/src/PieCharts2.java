...
public class PieCharts2 extends ApplicationFrame {
	/**
	 * 
	 */
	...
	public PieCharts2(String s, double[] d) {
		super(s);
		this.setD(d);
	...
	public static PieDataset createDataset() {
		...
		defaultpiedataset.setValue("已背数量", d[0]);
		defaultpiedataset.setValue("总数", d[1]);
